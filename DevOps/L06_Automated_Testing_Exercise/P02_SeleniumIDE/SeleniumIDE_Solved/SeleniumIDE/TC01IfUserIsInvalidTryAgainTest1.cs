...
public class TC01IfUserIsInvalidTryAgainTest
{
    ...
    private ChromeOptions options;       //  Added for Headless browser
    ...
    public void SetUp()
    {
        options = new ChromeOptions();          //  Added for Headless browser
        options.AddArgument("--headless");      //  Added for Headless browser
        driver = new ChromeDriver(options);     //  Added for Headless browser

        //driver = new ChromeDriver();            //  No Headless browser
