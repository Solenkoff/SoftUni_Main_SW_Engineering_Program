type operationType1 = 'power' | 'log';
type operationType2 = 'add' | 'subtract' | 'multiply' | 'divide';

class Calculator {
    calculate(operation: operationType1, num1: number, num2: number): number;
    calculate(operation: operationType2, num1: number, num2: number, num3?: number, num4?: number): number;
    calculate(operation: operationType1 | operationType2, num1: number, num2: number, num3?: number, num4?: number) {
