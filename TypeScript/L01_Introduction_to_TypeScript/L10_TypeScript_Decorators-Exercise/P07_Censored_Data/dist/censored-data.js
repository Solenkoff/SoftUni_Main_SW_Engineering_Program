...
function getLatest(seconds) {
    return function (target, methodName, descriptor) {
        ...
        descriptor.value = function () {
            ...
            const recentItems = allItems.filter((itme) => currentTime.getTime() - itme.createdOn.getTime() <= (seconds * 1000));
            return recentItems;
        };
        return descriptor;
    };
...
function logMessage(target, methodName, descriptor) {
    const originalMethod = descriptor.value;
    descriptor.value = function () {
...
//# sourceMappingURL=censored-data.js.map