...
class HolidayManager<T extends Holiday, U extends TravelVacation | MountainVacation | BeachVacation> implements VacationManager<T, U> {

    private reservations: Map<T,U> = new Map();
...
// holidayManager.reserveVacation(holiday, BeachVacation.ScubaDiving);                    //TS errors: BeachVacation.ScubaDiving not assignable to MountainVacation
// holidayManager.reserveVacation(holiday2, TravelVacation.InCountry);                    //TS errors: TravelVacation.InCountry not assignable to MountainVacation
// console.log(holidayManager.listReservations()) 
